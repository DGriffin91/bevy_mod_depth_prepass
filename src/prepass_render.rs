use bevy::{
    ...
    pbr::{
        DrawMesh, MaterialPipelineKey, MeshPipeline, MeshPipelineKey, MeshUniform, RenderMaterials,
...
use crate::prepass::{AlphaMask3dPrepass, Opaque3dPrepass, ViewPrepassTextures};
...
pub struct PrepassPlugin<M: Material>(pub PhantomData<M>);
...
impl<M: Material> FromWorld for PrepassPipeline<M> {
    fn from_world(world: &mut World) -> Self {
        ...
        PrepassPipeline {
            ...
            material_vertex_shader: None,   //Just use default for now
            material_fragment_shader: None, //Just use default for now
    ...
    M::Data: PartialEq + Eq + Hash + Clone,
{
    ...
    fn specialize(
            ...
            && layout.contains(Mesh::ATTRIBUTE_JOINT_WEIGHT)
        {
            ...
            bind_group_layout.insert(1, self.skinned_mesh_layout.clone());
        } else {
            bind_group_layout.insert(1, self.mesh_layout.clone());
        }
...
//    views_3d: Query<
//        (Entity, &ExtractedCamera, &PrepassImage),
//        (
...
//            };
//
//            let cached_normals_depth_texture = prepass_settings.output_normals.then(|| {
//                normal_textures
...
//                normals_depth: cached_normals_depth_texture,
//                size,
//            });
//        }
//    }
    ...
    M::Data: PartialEq + Eq + Hash + Clone,
{
    ...
    let alpha_mask_draw_prepass = alpha_mask_draw_functions
        ...
        .get_id::<DrawPrepass>()
        .unwrap();
    for (view, visible_entities, _prepass_textures, mut opaque_phase, mut alpha_mask_phase) in
        &mut views
    {
